...
/// <summary>
/// Attribute used to configure an Amazon Kinesis output binding for in-process Azure Functions.
/// </summary>
[Binding]
[AttributeUsage(AttributeTargets.Parameter | AttributeTargets.ReturnValue)]
public sealed class KinesisOutAttribute : Attribute
{
    /// <summary>
    /// Gets or sets the name of the Kinesis stream.
    /// </summary>
    [AutoResolve]
